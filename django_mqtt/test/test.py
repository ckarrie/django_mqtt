...
# because the functions these tests are testing are not being used throughout the project, I've disabled them
...
#         self.assertEqual(gen_string(b'\xff'), '')
#         self.assertEqual(gen_string(None), '')
#         self.assertEqual(gen_string(object), '')
#         self.assertEqual(gen_string(b'\xff\xff\x00'), '')
#         self.assertEqual(gen_string(b'\x00\x02\x00\x00'), b'\x00\x02\x00\x02')
#         self.assertEqual(gen_string(b'\x00\x01\xC0'), '')
#         self.assertEqual(gen_string(b'\x00\x01\xC1'), '')
#         self.assertEqual(gen_string(b'\x00\x01\xF5'), '')
#         self.assertEqual(gen_string(b'\x00\x01\xFF'), '')
#
...
#         self.assertEqual(gen_string(str(u'')), b'\x00\x00')
#
...
#         self.assertEqual(gen_string(str(u'\u65E5\u672C\u8A9E')), b'\x00\x09\xE6\x97\xA5\xE6\x9C\xAC\xE8\xAA\x9E')
#
...
#         self.assertEqual(get_string('\x00\x01\x00'), b'\x00')
#
